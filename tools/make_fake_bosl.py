...
def FakeBoSL(name:str="FakeBoSL0"):
    ...
    transport = RequestsHTTPTransport(url="https://***REMOVED***/graphql",headers={'Authorization':'Bearer nNgr-OJA-K2cNLkfZWQ0B-Xzlrkb9coN'},verify=True,retries=3)

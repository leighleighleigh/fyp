...
// For Adafruit IO:
#define AIO_SERVER "cms.leigh.sh"
...
void sendPOST()
{
    ...
    sprintf(URL, "http://cms.leigh.sh/flows/trigger/625c3333-48bf-4397-a5a6-a0d72e204b6f?access_token=%s",token);
    // sprintf(URL, "http://cms.leigh.sh/items/column_sensors?access_token=%s",token);

    // First part of JSON data payload
    sprintf(body, "{\"data\":\"BW3,1234,4000\"}");
